...
export class ConstantService {
  ...
  public master_empty: Master = { nick: '', level: 1, exp: 0, region_ini: '', poke_ini: this.poke_empty, capturados: this.pokes_empty, team: this.pokes_empty, favoritos: [], money: 1500, items: [] };
